...
const todos = [...animacion, 'src/scripts/menu.ts', 'src/scripts/cuenta-regresiva.ts', 'src/scripts/formulario.ts', 'src/scripts/tema.ts', 'src/scripts/lib/color.ts', 'src/scripts/anuncios.ts', 'src/scripts/mapa.ts', 'src/scripts/imprimir.ts', 'src/scripts/asistencia.ts', 'src/lib/asistencia.ts'];
