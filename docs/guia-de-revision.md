...
| Fotos del hero al cambiar de tema | **Bug que encontraste vos.** Fueron tres cosas distintas y la última no la pude reproducir nunca, así que se cerraron los dos caminos por los que podía pasar en vez de adivinar: el lienzo del efecto ya no puede taparla (pasó a transparente, así que si queda vacío se ve la foto de abajo) y el velo del cambio de tema ya no puede quedarse arriba (lo baja una animación de CSS, no el script). | Cambiá de tema muchas veces seguidas, rápido y despacio, en la compu y en el celular. **Si vuelve a pasar, sacame una captura**: significa que es un tercer camino que no vi. |
